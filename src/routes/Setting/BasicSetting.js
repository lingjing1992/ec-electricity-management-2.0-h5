...
export default class BasicSetting extends Component {
  ...
  render() {
    ...
    return (
      <Card className={styles.basicSetting} style={{ minHeight: 780, marginBottom: 56 }} title={languageForBasicSetting.StockAlert}>
        <Spin spinning={loading}>
          <Form>
              ...
              <FormItem className={`left`}>
                {
                  getFieldDecorator('stock', {
                    ...
                    >
                      <Option key={1} value={1}>SPU</Option>
                    </Select>,
                  )
                }
              </FormItem>
              <div style={{ margin: '0 8px' }} className={`left ant-form-item-label`}>≤</div>
              <FormItem className={`left`}>
                {
            ...
            <FormItem className={styles.notificationForm} label={languageForBasicSetting.NotificationForm}>
              {
            ...
            <FormItem label={languageForBasicSetting.InformTheFrequency}>
              {
                getFieldDecorator('noticeRate', {
                  ...
                  <Select
                    className={`select-size-small`}
                  >
                    <Option key={1} value={1}>{languageForBasicSetting.OnlyOnce}</Option>
                  </Select>,
                )
              }
            </FormItem>
