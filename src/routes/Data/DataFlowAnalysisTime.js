...
export default class DataGoodsSales extends Component {
  ...
  handleTableChange = (pagination, filters, sorter) => {
    ...
    this.props.dispatch({
      type: 'dataFlowAnalysis/changeSortOrder',
      payload: Object.assign({
        sortedInfo: sorter,
      }),
    });
    ...
    const { dataFlowAnalysis } = this.props;
    console.log('this=>', this);
    console.log('dataFlowAnalysis.pushData', dataFlowAnalysis.pushData);
    this.props.dispatch({
      type: `dataFlowAnalysis/${type}GetDataFlowAnalysis`,
      payload: Object.assign(
        dataFlowAnalysis.pushData, {
  ...
  render() {
    ...
    const { type } = this.state;
    const { dataFlowAnalysis } = this.props;
    const { dataFlowAnalysis: { loading, pushData } } = this.props;
    ...
    const columns = [
      ...
      },
      {
        ...
        classType: 3,
        sorter: true,
        sortOrder: sortedInfo.columnKey === 'orderPayCount' && sortedInfo.order,
        render: (text, record) => {
          return (
            <div>
              {text}
      ...
      },
      {
        ...
        classType: 2,
        sorter: true,
        sortOrder: sortedInfo.columnKey === 'orderRate' && sortedInfo.order,
        render: (text, record) => {
          return (
            <div>
              {text}
      ...
      },
      {
        ...
        classType: 2,
        sorter: true,
        sortOrder: sortedInfo.columnKey === 'salesRate' && sortedInfo.order,
        render: (text, record) => {
          return (
            <div>
              {text}
      ...
      },
      {
        ...
        classType: 2,
        sorter: true,
        sortOrder: sortedInfo.columnKey === 'perCustomerTransaction' && sortedInfo.order,
        render: (text, record) => {
          return (
            <div>
              {text}
              ...
              <div>
                ...
                >
                  {getFieldDecorator('dealTime', {
                    rules: [{ required: false, message: `${languageForGlobal.Enter+''+languageForData.Time}!` }],
