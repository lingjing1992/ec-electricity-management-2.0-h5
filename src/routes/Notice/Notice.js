...
export default class Notice extends Component {
  ...
  componentWillReceiveProps(nextProps){
    if(this.props.notice.type !== nextProps.notice.type || (this.props.notice.isUpdate !== nextProps.notice.isUpdate && nextProps.notice.isUpdate) ){
  ...
  render(){
    ...
    return(
      <div id={styles.notice}>
        <Tabs activeKey={noticeQueryParams.type.toString()} onChange={this.tabOnChange} className={newTabPanes.length===1 ? styles.aloneTab : ''}>
          {
